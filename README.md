...
- **💸 Free and Open-Source**: Cineverse is completely free to use and the source code is available for anyone to explore, contribute, and build upon.
...
Cineverse is built using the following technologies:
...
- **The Movie Database (TMDB) API**: Cineverse integrates with the TMDB API to retrieve movie and TV show data, ensuring access to a vast and up-to-date content library.
...
4. Open your browser and visit `http://localhost:3000` to access the Cineverse application.

## Contributing

Contributions to Cineverse are welcome! If you'd like to contribute, please refer to the [CONTRIBUTING](CONTRIBUTING.md) file for guidelines and instructions.
